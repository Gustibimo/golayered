...
/*
This handler can be tested without depending on the datastore.
You can mock the responses from the datastore
and write the unit tests, testing only the handlers.
*/
